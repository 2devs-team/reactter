...
extension SignalNumExt on Signal<num> {
  ...
  /// Examples:
  /// ```dart
  /// print(Signal(1).compareTo(2)); // => -1
  /// print(Signal(2).compareTo(1)); // => 1
  /// print(Signal(1).compareTo(1)); // => 0
  ///
  /// // The following comparisons yield different results than the
  /// // corresponding comparison operators.
  /// print(Signal(-0.0).compareTo(0.0));  // => -1
  ...
  ///
  /// ```dart
  /// print(Signal(2).abs()); // 2
  /// print(Signal(-2.5).abs()); // 2.5
  /// ```
  num abs() => value.abs();
  ...
  /// For doubles, `Signal(-0.0).sign` is `-0.0`.
  ///
  ...
  ///  `Signal(3.5).round() == 4` and `Signal(-3.5).round() == -4`.
  ///
  ...
  ///
  /// Rounds away from zero when there is no closest integer:
  ///  `Signal(3.5).roundToDouble() == 4` and `Signal(-3.5).roundToDouble() == -4`.
  ///
  ...
  /// Example:
  /// ```dart
  /// var result = Signal(10.5).clamp(5, 10.0); // 10.0
  /// result = Signal(0.75).clamp(5, 10.0); // 5
  /// result = Signal(-10).clamp(-5, 5.0); // -5
  /// result = Signal(-0.0).clamp(-5, 5.0); // -0.0
  /// ```
  ...
  /// Examples:
  /// ```dart
  /// Signal(1).toStringAsFixed(3);  // 1.000
  /// Signal(4321.12345678).toStringAsFixed(3);  // 4321.123
  /// Signal(4321.12345678).toStringAsFixed(5);  // 4321.12346
  /// Signal(123456789012345).toStringAsFixed(3);  // 123456789012345.000
  /// Signal(10000000000000000).toStringAsFixed(4); // 10000000000000000.0000
  /// Signal(5.25).toStringAsFixed(0); // 5
  /// ```
  ...
  /// Examples:
  /// ```dart
  /// Signal(1).toStringAsExponential();       // 1e+0
  /// Signa(1).toStringAsExponential(3);      // 1.000e+0
  /// Signal(123456).toStringAsExponential();  // 1.23456e+5
  /// Signal(123456).toStringAsExponential(3); // 1.235e+5
  /// Signal(123).toStringAsExponential(0);    // 1e+2
  /// ```
  ...
  /// Examples:
  /// ```dart
  /// Signal(1).toStringAsPrecision(2);       // 1.0
  /// Signal(1e15).toStringAsPrecision(3);    // 1.00e+15
  /// Signal(1234567).toStringAsPrecision(3); // 1.23e+6
  /// Signal(1234567).toStringAsPrecision(9); // 1234567.00
  /// Signal(12345678901234567890).toStringAsPrecision(20); // 12345678901234567168
  /// Signal(12345678901234567890).toStringAsPrecision(14); // 1.2345678901235e+19
  /// Signal(0.00000012345).toStringAsPrecision(15); // 1.23450000000000e-7
  /// Signal(0.0000012345).toStringAsPrecision(15);  // 0.00000123450000000000
  /// ```
  String toStringAsPrecision(int precision) =>
      value.toStringAsPrecision(precision);
}

extension SignalNumNullExt on Signal<num?> {
  /// Compares this to `other`.
  ///
  /// Returns a negative number if `this` is less than `other`, zero if they are
  /// equal, and a positive number if `this` is greater than `other`.
  ...
  /// ```dart
  /// Signal(1).toStringAsExponential();       // 1e+0
  /// Signal(1).toStringAsExponential(3);      // 1.000e+0
  /// Signal(123456).toStringAsExponential();  // 1.23456e+5
  /// Signal(123456).toStringAsExponential(3); // 1.235e+5
  /// Signal(123).toStringAsExponential(0);    // 1e+2
  /// ```
