...
extension ObjBigIntExt on Obj<BigInt> {
  ...
  /// Example:
  /// ```dart
  /// var value = Obj(BigInt.from(1000));
  /// print(value.pow(0)); // 1
  ...
  ///
  /// ```dart
  /// Obj(BigInt.from(-1)).toUnsigned(5) == 31   // 11111111  ->  00011111
  /// ```
  ///
  ...
  ///
  /// ```dart
  /// var big15 = Obj(BigInt.from(15));
  /// var big16 = Obj(BigInt.from(16));
  /// var big239 = Obj(BigInt.from(239));
  ///                                //     V--sign bit-V
...
extension ObjBigIntNullExt on Obj<BigInt?> {
  /// Returns the absolute value of this integer.
  ///
  /// For any integer `x`, the result is the same as `x < 0 ? -x : x`.
  BigInt? abs() => value?.abs();
