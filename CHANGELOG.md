...
- Add [`Rt.registerState`](https://pub.dev/documentation/reactter/8.0.0/reactter/RtInterface/registerState.html) method to create a new state.
...
- Replace [`LifecycleObserver`](https://pub.dev/documentation/reactter/7.3.0/reactter/LifecycleObserver-class.html) to [`RtDependencyLifecycle`](https://pub.dev/documentation/reactter/8.0.0/reactter/RtDependencyLifecycle-class.html).
...
- **fix(framework):** Add instance attached validation before `UseCompute` is disposed.
