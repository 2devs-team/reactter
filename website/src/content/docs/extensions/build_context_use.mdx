...
<HT><a href="https://pub.dev/documentation/flutter_reactter/latest/flutter_reactter/ReactterBuildContextExtension/use.html" target="_blank">`BuildContext.use`</a></HT> is a method that gets an instance of <HT>`T`</HT> dependency from the nearest ancestor provider(<HT>[`RtProvider`](/reactter/widgets/rt_provider)</HT> or <HT>[`RtComponent`](/reactter/widgets/rt_component)</HT>) of type <HT>`T`</HT>.
