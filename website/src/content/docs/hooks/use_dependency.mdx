...
:::tip
Firts of all, you need to understand the concept of [dependency injection](/reactter/core_concepts/dependency_injection) to use this hook.
:::
...
Also, you can create the dependency instance inmediately by using the <HT>`UseDependency.create`</HT> hook instead. Learn more about it in [Creating a dependency](/reactter/hooks/use_dependency#creating-a-dependency).
:::
