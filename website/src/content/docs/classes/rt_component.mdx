...
It provides features similar to <HT>[`RtProvider`](/reactter/widgets/rt_provider)</HT> and <HT>[`RtConsumer`](/reactter/widgets/rt_consumer)</HT> that are used to inject and consume dependencies.
