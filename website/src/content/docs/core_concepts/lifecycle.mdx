...
:::note
This page assumes you've already read the [Rendering Control](/reactter/core_concepts/rendering_control) page.
Read first if you are new to Reactter.
:::
...
- `Lifecycle.initialized`: is triggered when the dependency has been initialized.
...
- `Lifecycle.destroyed`: is triggered when the dependency has been destroyed.
...
```dart title="counter.dart" "Reactter.on" "Lifecycle.willMount" "Lifecycle.didMount" "Lifecycle.willUpdate" "Lifecycle.didUpdate" "Lifecycle.willUnmount" "Lifecycle.didUnmount"
...
```dart title="counter_app.dart" collapse={1-100} /Counter(?!\u0060)(?!Page)/ "Counter()" /counter(?!\\.dart)/ "counter.increment" "counter.decrement" "counter.count" "ReactterProvider" "ReactterConsumer"
...
Extend your instances with <a href="https://pub.dev/documentation/reactter/latest/reactter/LifecycleObserver-class.html" target="_blank">`LifecycleObserver`</a>
...
```dart title="counter.dart" "LifecycleObserver" "onInitialized" "onDidMount" "onWillMount" "onWillUpdate" "onDidUpdate" "onWillUnmount" "onDidUnmount"
import 'package:reactter/reactter.dart';
