...
- Methods
  - <HM>[`Reactter.on`](/reactter/methods/to_manage_event/on)</HM>
  - <HM>[`Reactter.one`](/reactter/methods/to_manage_event/one)</HM>
  - <HM>[`Reactter.off`](/reactter/methods/to_manage_event/off)</HM>
  - <HM>[`Reactter.offAll`](/reactter/methods/to_manage_event/offAll)</HM>
  - <HM>[`Reactter.emit`](/reactter/methods/to_manage_event/emit)</HM>
