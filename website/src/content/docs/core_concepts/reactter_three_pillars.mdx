...
:::note
  The **hooks** (also known as <a href="https://pub.dev/documentation/reactter/latest/reactter/ReactterHook-class.html" target="_blank">`ReactterHook`</a>) are named with the prefix `Use` according to convention.
:::
...
All state in Reactter are classes that inherit <a href="https://pub.dev/documentation/reactter/latest/reactter/ReactterState-class.html" target="_blank">`ReactterState`</a>,
