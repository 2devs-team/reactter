...
- Mixins
  - <HT>[`RtStateBase`](/reactter/api/classes/RtStateBase)</HT>
- Classes
...
Reactter offers three fundamental approaches for creating states: <HT>[`RtStateBase`](/reactter/api/classes/RtStateBase)</HT>, <HT>[`Signal`](/reactter/api/classes/signal)</HT> and <HT>[`Hooks`](/reactter/core_concepts/hooks)</HT>.
