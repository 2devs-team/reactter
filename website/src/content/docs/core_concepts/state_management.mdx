...
- Methods
  - <HM>[`Reactter.lazyState`](/reactter/methods/to_manage_state/lazy_state)</HM>
  - <HM>[`Reactter.batch`](/reactter/methods/to_manage_state/batch)</HM>
  - <HM>[`Reactter.untracked`](/reactter/methods/to_manage_state/untracked)</HM>
