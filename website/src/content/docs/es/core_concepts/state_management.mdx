...
- Mixins
  - <HT>[`RtStateBase`](/reactter/es/api/classes/RtStateBase)</HT>
- Clases
...
Reactter ofrece tres enfoques fundamentales para crear estados: <HT>[`RtStateBase`](/reactter/es/api/classes/RtStateBase)</HT>, <HT>[`Signal`](/reactter/es/api/classes/signal)</HT> y <HT>[`Hooks`](/reactter/es/core_concepts/hooks)</HT>.
