...
import mainUsingIdCode from '@/examples/reactter_provider_using_id/lib/main.dart?raw';
...
import mainUsingChildCode from '@/examples/reactter_provider_using_child/lib/main.dart?raw';
...
import mainUsingModeCode from '@/examples/reactter_provider_using_mode/lib/main.dart?raw';
...
<CodeTabs>
  ...
  <Tabs>
    ...
    <TabItem label="main.dart">
      <Code code={mainUsingIdCode} lang="dart" mark={marks} />
    </TabItem>
  </Tabs>
</CodeTabs>
...
<CodeTabs>
  ...
  <Tabs>
    ...
    <TabItem label="main.dart">
      <Code code={mainUsingChildCode} lang="dart" mark={marks} />
    </TabItem>
  </Tabs>
</CodeTabs>
...
<CodeTabs>
  ...
  <Tabs>
    ...
    <TabItem label="main.dart">
      <Code code={mainUsingModeCode} lang="dart" mark={marks} />
    </TabItem>
  </Tabs>
</CodeTabs>